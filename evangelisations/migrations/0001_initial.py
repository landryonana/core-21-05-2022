# Generated by Django 2.2.24 on 2022-05-05 01:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contacts', models.PositiveIntegerField(blank=True, error_messages={'unique': 'Le numéro de télephone existe déjà'}, help_text='Le numéro de téléphone doit avoir 09 chiffres', null=True, unique=True, verbose_name='Numéro de téléphone')),
                ('quartier_d_habitation', models.CharField(blank=True, help_text='ce champ doit avoir au moins trois caractères', max_length=200, null=True, verbose_name="Quartier d'habitation")),
                ('accepte_jesus', models.CharField(choices=[('oui', 'Oui'), ('non', 'Non'), ('ras', 'Indécis'), ('déjà', 'Déjà')], max_length=15, verbose_name='Accepté JÉSUS')),
                ('sexe', models.CharField(choices=[('masculin', 'Masculin'), ('féminin', 'Féminin')], max_length=15, verbose_name='Sexe')),
                ('whatsapp', models.CharField(blank=True, choices=[('oui', 'Oui'), ('non', 'Non')], max_length=15, null=True, verbose_name='Whatsapp')),
                ...
                ('author', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='auth_personnes', to=settings.AUTH_USER_MODEL, verbose_name='Enrgistré par ')),
                ('boss', models.ManyToManyField(blank=True, help_text='selectionner les personnes ayant évangelisés cette personne', related_name='personnes', to='evangelisations.Participant', verbose_name="Qui l'ont évangelisé ?")),
                ('evangelisation', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='personnes', to='evangelisations.Evangelisation', verbose_name="Moment d'évangelisation")),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('choix_person', models.CharField(choices=[('---', '---'), ('rester', 'Rester'), ('passager', 'Passager'), ('indécis', 'Indécis')], default=0, max_length=25, verbose_name='Choix de la personne')),
                ...
                ('person', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='suivi', to='evangelisations.Person', verbose_name='Personne')),
            ],
        ),
        migrations.CreateModel(
            name='Site',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('evangelisation', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='images', to='evangelisations.Evangelisation', verbose_name='Évangelsation du ')),
            ],
        ),
        migrations.AddField(
            model_name='evangelisation',
            name='boss',
            field=models.ManyToManyField(blank=True, related_name='participations', to='evangelisations.Participant', verbose_name='Qui sont présents ?'),
        ),
        migrations.AddField(
            model_name='evangelisation',
            name='site',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='evangelisations', to='evangelisations.Site', verbose_name="Lieu d'évangelisation"),
        ),
    ]
