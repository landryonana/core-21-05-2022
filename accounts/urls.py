...
urlpatterns = [
    ...
    path('comptes/<int:pk>/supprimer', views.user_delete, name="user_delete"),
    path('comptes/supprimer', views.user_delete_users, name="user_delete_users"),
    #====================AJAX LEAVE
    path('comptes/details', views.user_detail, name="user_detail"),
    path('comptes/<int:pk>/details', views.user_detail, name="user_detail"),
