...
from evangelisations.utils import (get_stat_evang_person_infos, month_name, month_evang, month_numer,
                                   get_personne_evang_all_by__year, get_personne_evang_all_by_jour_and_mois_and_year,
                                   get_personne_evang_all_by_mois_and_year,
                                   get_personne_evang_by_jour_and_mois_and_year, get_personne_evang_by_mois_and_year,
                                   get_personne_evang_by_year,
                                   get_personne_total, get_stat_oui_jesus_by_mois)
from evangelisations.models import Evangelisation, Person
...
def rapport_app_detail(request, pk, annee):
    ...
    for evang in evangs_mois:
        ...
        nbre_hommes = len(evang.boss.filter(sexe='masculin'))
        nbre_femmes = len(evang.boss.filter(sexe='féminin'))
        nbre_participants = len(evang.boss.all())
